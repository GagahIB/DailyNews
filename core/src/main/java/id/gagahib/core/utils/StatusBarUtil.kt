...
//<editor-fold desc="DarkMode">
        ...
        /**
         * Set whether the status bar of MIUI6+ is darkMode,
         * the font color and icon turn black when darkMode
        ...
        /*
         * increase View of paddingTop,
         * The added value is the height of the status bar (intelligent judgment, and set the height)
         */
        ...
        /*
         * increase View Height and paddingTop,
         * The increased value is the height of the status bar.
         * 一 It is generally used for ToolBar in immersive full screen
         *
         */
        ...
        /*
         * Increase the top margin of View（MarginTop）
         * Generally, the height is WARP_CONTENT For small controls
         */
